...
#   run_pattern_reconstruction_cpx.sh m24p|m14p|m15p|m15c|m17p|m17p2|m17p2r|m18p|m21p
#
...
cell=${1:?expected one of: m24p, m14p, m15p, m15c, m17p, m17p2, m17p2r, m18p, m21p}
...
extra_args=()
if [[ "$cell" == "m15p" || "$cell" == "m15c" || "$cell" == "m18p" || "$cell" == "m21p" ]]; then
