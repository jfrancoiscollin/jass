"""Contracts of the architecture-correct PatternEval reconstruction program."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "l1_pattern_conditional_temporal_composition.yaml",
            M15C2.COMPOSITION_SCHEMA,
            "M15-C3",
        ),
        (
            "l1_pattern_conditional_residual_path.yaml",
            M15C2.RESIDUAL_SCHEMA,
            "M15-C4",
        ),
