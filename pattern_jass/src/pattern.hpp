...
//
// v5 (DIAG-ENRICHED geometry) : 40 patterns × 12 squares, ternary encoding.
...
constexpr std::size_t NUM_PATTERNS  = 40;   // v5 diag-enriched (gen_patterns.py)
...
// 40 patterns of 12 squares (v5). Generated by gen_patterns.py --emit.
