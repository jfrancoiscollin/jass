...
void HubFrontEnd::emit_bestmove(const SearchResult& r) {
    ...
    out_ << "bestmove " << format_move(r.best_move)
         ...
         << " qsearchcalls=" << r.qsearch_calls
         << " qnodes=" << r.qnodes
         << " ttprobes=" << r.tt_probes
         << " tthits=" << r.tt_hits
         << " reductions=" << r.reductions
         << " reducedplies=" << r.reduced_plies
         << " lmrresearch=" << r.lmr_researches
         << " extensions=" << r.extensions
         << " singext=" << r.singular_extensions
         << " promoext=" << r.promotion_extensions
         << " forcingext=" << r.forcing_extensions
         << " singleext=" << r.single_reply_extensions
         << " nullprobes=" << r.null_probes
         << " nullcuts=" << r.null_cutoffs
         << " ordergood=" << r.ordering_good_updates
         << " orderbad=" << r.ordering_bad_updates
