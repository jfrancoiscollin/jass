...
// Structural extras (1st batch, quality axis). Draughts-meaningful, cheap.
inline constexpr int EXTRA_BLACK_KMOB   = 106;  // black KING slide mobility (men-mob = MOB − KMOB)
...
inline constexpr int EXTRA_BLACK_ADV    = 110;  // black men advancement (Σ row, higher = nearer promo)
