#!/usr/bin/env python3
"""Launch-V2 evidence wrapper for frozen CLS-D search-profile diagnostic."""
...
from jobs.tools import cls_search_profile_stage as stage  # noqa: E402
from jobs.tools.launch_runtime_v2 import StageEvidence, atomic_json  # noqa: E402

PHASES = ["execute-cls-search-profile"]
...
def main() -> int:
    ...
    try:
        ...
        stage.run_stage(result / "cls-search-profile-work", art)
