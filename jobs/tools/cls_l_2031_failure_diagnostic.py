#!/usr/bin/env python3
"""Bounded technical diagnostic for failed CLS-L normalization preflight 2031.
...
FAILED_JOB = "cpx62-2031-l3-cls-l-source-normalization-preflight-v6"
FAILED_ATTEMPT = "20260917T131839Z-1088c921"
FAILED_CODE = "1088c921c93fd35f71276e57fd40b1abb22eb5e4"
FAILED_PREFIX = f"r2:jass-data/runs/{FAILED_JOB}/{FAILED_ATTEMPT}"
TERMINAL = "CLS_L_2031_TECHNICAL_DIAGNOSTIC_COMPLETE_V1"
PHASE = "execute-cls-l-2031-failure-diagnostic"
ERROR_RE = re.compile(
...
def main() -> int:
    ...
    work = result_dir / "work" / "failed-2031"
    ...
    diagnostic = {
        "schema": "jass.cls_l_2031_failure_diagnostic.v1", "terminal": TERMINAL, "state": "completed",
    ...
    write_json(art / "source-authentication.json", {
        "schema": "jass.cls_l_2031_failed_source_authentication.v1", "authenticated": True,
    ...
    summary = {
        "schema": "jass.cls_l_2031_failure_diagnostic_summary.v1", "terminal": TERMINAL, "state": "completed",
        "classification": "TECHNICAL_DIAGNOSTIC", "scientific_verdict": None,
        ...
        "next_stage": "REPAIR_PROVEN_2031_MECHANICS_ONLY"}
    runtime_atomic_json(art / "scientific-summary.json", summary)
    write_json(art / "manifest.json", {"schema": "jass.cls_l_2031_failure_diagnostic_manifest.v1",
    ...
    (art / "RESULTS.md").write_text(
        f"# CLS-L 2031 technical failure diagnostic\n\n- terminal: `{TERMINAL}`\n"
