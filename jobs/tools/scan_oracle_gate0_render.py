#!/usr/bin/env python3
"""Add the Gate-0 scorer target to an isolated source copy only."""
...
# Benchmark-only Scan-oracle Gate 0 scorer (isolated execution copy).
...
def render(path: Path) -> None:
    ...
    if "jass_scan_oracle_gate0_runtime" in text:
