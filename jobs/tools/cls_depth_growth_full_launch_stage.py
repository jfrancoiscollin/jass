#!/usr/bin/env python3
"""Launch-V2 evidence wrapper for frozen FULL-512 CLS-D depth/growth."""
...
from jobs.tools import cls_depth_growth_full_stage as stage  # noqa: E402
from jobs.tools.launch_runtime_v2 import StageEvidence, atomic_json  # noqa: E402

PHASES = ["execute-full-depth-growth"]
...
def main() -> int:
    ...
    try:
        ...
        summary = stage.run_stage(result / "cls-depth-growth-full-work", art)
