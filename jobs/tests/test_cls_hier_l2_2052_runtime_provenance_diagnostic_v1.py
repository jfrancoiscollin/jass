...
class CLSHierL22052RuntimeProvenanceDiagnosticV1Tests(unittest.TestCase):
    def test_source_identities_and_terminal_are_frozen(self):
        ...
        self.assertEqual(diag.HIST_RUNTIME_JOB, "cpx62-1340-jass-megacorpus-comparative-fit-v1")
        self.assertEqual(diag.HIST_RUNTIME_ATTEMPT, "20260814T123246Z-2ce07222")
        self.assertEqual(diag.HIST_RUNTIME_CODE, "2ce07222f86c1468a1081fbdc53e9e17a0c5326e")
    ...
    def test_profile_is_zero_effect_and_source_is_runtime_only(self):
        ...
        self.assertIn("cpx62-1340-jass-megacorpus-comparative-fit-v1", code)
