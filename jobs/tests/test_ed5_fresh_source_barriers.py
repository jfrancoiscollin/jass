...
class Ed5FreshSourceBarrierTests(unittest.TestCase):
    ...
    def test_w_seed_and_information_boundary_are_frozen(self):
        ...
        self.assertIn("ED4_W1959_DIGEST = \"25dc7654ff5423fb132d2060f137c077bf4f326a55b26218ef06736178d2361a\"", text)
        self.assertIn("historical_w_ids = fetch_ed4_w1959(result)", text)
        self.assertIn("if primary_d_overlap or primary_historical_overlap:", text)
        self.assertIn("w_reserve_canonical_collision_with_historical", text)
        self.assertIn('"pre_target_historical_collision": historical_entry', text)
