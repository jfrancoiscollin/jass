...
TEMPLATE = (
    ROOT
    / "jobs/templates/l3-curriculum-error-residual-ridge-path-screen-v1.sh"
).read_text(encoding="utf-8")


class ResidualRidgePathScreenTemplateTests(unittest.TestCase):
    def test_screen_is_training_only_and_cannot_continue(self) -> None:
        for marker in (
            ...
            "FEATURE_AUDIT_AUTHORIZED__FALSE",
    ...
    def test_only_materialized_gate_fit_training_data_are_fetched(self) -> None:
    ...
    def test_terminal_report_keeps_all_forbidden_counters_at_zero(self) -> None:
        for marker in (
            ...
            "FEATURE_AUDIT_PROFILE_ROWS_EXAMINED__0",
