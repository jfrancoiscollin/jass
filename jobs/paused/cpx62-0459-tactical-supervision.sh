#!/usr/bin/env bash
# id: cpx62-0459-tactical-supervision
...
ART="/root/jass/jobs/results/cpx62-0459-tactical-supervision/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-tacsup62; rm -rf "$W"; mkdir -p "$W"
...
GEOM32=/root/jass-geom32-tacsup62
POOL_TRIM=25000000; NEGDB=4000000; NTAC=600000; RELABEL_D=16; MID_LO=14; MID_HI=40; OVERSAMPLE=4
