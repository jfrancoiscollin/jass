...
ART="/root/jass/jobs/results/ccx33-0453-egdb-fit/artefacts"; mkdir -p "$ART"
...
GEOM32=/root/jass-geom32-egdbfit
NTRAIN=3000000; NTEST=40000; L2=3e-5; MAXIT=25; CHUNK=1000000; BAND=40

# auto-detection du repertoire egdb (ccx33=/root/egdb_db, cpx62=/root/egdb_extracted)
