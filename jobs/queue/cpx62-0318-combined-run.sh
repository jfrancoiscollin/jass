...
ART="/root/jass/jobs/results/cpx62-0318-combined-run/artefacts.src"; mkdir -p "$ART"
...
echo; echo "=========================================================="
echo "   cpx62-0318 — RUN COMBINÉ (le vrai test, données enrichies)"
