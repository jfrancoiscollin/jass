...
ART="/root/jass/jobs/results/cpx62-0608-rank-g1/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0608-rank-g1/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-rankg1b; rm -rf "$W"; mkdir -p "$W"; GEOM=/root/jass-geom32-rank
