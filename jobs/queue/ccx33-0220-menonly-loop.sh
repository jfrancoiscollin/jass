...
set -uo pipefail
cd /root/jass
ART="/root/jass/jobs/results/ccx33-0220-menonly-loop/artefacts.src"; mkdir -p "$ART"
...
echo; echo "=========================================================="
echo "   cpx62-0219 — PHASE 1 MEN-ONLY (témoin) — TRAJECTOIRE Elo"
