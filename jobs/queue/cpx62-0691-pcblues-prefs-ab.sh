#!/usr/bin/env bash
# id: cpx62-0691-pcblues-prefs-ab
...
ART="/root/jass/jobs/results/cpx62-0691-pcblues-prefs-ab/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0691-pcblues-prefs-ab/artefacts"
W=/root/cw-pcbab2; rm -rf "$W"; mkdir -p "$W"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
CHAMP_GZ=jobs/results/BAKE-gen2-mmto/artefacts/champion-gen2-mmto.pjtw.gz
CAND_DIR=jobs/results/cpx62-0690-pcblues-prefs-finetune/artefacts
