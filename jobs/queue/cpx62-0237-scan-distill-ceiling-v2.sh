#!/usr/bin/env bash
# id: cpx62-0237-scan-distill-ceiling-v2
...
set -uo pipefail
cd /root/jass
ART="/root/jass/jobs/results/cpx62-0237-scan-distill-ceiling-v2/artefacts.src"; mkdir -p "$ART"
...
echo; echo "=========================================================="
echo "   cpx62-0237 — PLAFOND DE DISTILLATION (classe full-fold 32-pat sur Scan-truth)"
