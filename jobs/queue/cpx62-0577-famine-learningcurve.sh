#!/usr/bin/env bash
# id: cpx62-0577-famine-learningcurve
...
ART="/root/jass/jobs/results/cpx62-0577-famine-learningcurve/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0577-famine-learningcurve/artefacts"
