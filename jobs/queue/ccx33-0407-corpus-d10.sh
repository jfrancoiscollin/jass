...
ART="/root/jass/jobs/results/ccx33-0407-corpus-d10/artefacts"; mkdir -p "$ART"
W=/root/cw-ccx33-0407-corpus-d10; rm -rf "$W"; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=10; EVAL_DEPTH=4; TARGET=350000; BATCH_MIN=25
