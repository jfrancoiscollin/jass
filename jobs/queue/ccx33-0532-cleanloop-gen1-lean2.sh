#!/usr/bin/env bash
# id: ccx33-0532-cleanloop-gen1-lean2
...
ART="/root/jass/jobs/results/ccx33-0532-cleanloop-gen1-lean2/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-cleanloop; rm -rf "$W"; mkdir -p "$W"
GEOM32=/root/jass-geom32-cleanloop

# ----- params -----
FRESH=400000; PLAY_DEPTH=10; LABEL_DEPTH=4; OPEN_PLIES=8; EXPLORE_EPS=5; MAXPLIES=200
...
[ "${NSP:-0}" -ge 300000 ] || { say "ABORT gen1 : corpus trop petit ($NSP)"; exit 7; }
