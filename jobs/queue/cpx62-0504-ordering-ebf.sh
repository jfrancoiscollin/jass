...
ART="/root/jass/jobs/results/cpx62-0504-ordering-ebf/artefacts"; mkdir -p "$ART"
...
declare -A SPEC=( [baseline]="iid_min_depth=0" [iid4]="iid_min_depth=4" [iid6]="iid_min_depth=6" [iid8]="iid_min_depth=8" [malus50]="hist_malus=50" [conthist]="use_conthist=1" )
for cfg in baseline iid4 iid6 iid8 malus50 conthist; do
...
python3 - "$W" baseline iid4 iid6 iid8 malus50 conthist <<'PY'
import sys,re
