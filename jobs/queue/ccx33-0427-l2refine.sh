...
ART="/root/jass/jobs/results/ccx33-0427-l2refine/artefacts"; mkdir -p "$ART"
...
L2S="1e-6 1e-5 3e-5"   # raffinage vers le bas : 3e-5 gagnait, tendance monotone -> chercher le vrai plancher
