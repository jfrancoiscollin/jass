#!/usr/bin/env bash
# id: cpx62-0226-lrclosed-fullfold
...
set -uo pipefail
cd /root/jass
ART="/root/jass/jobs/results/cpx62-0226-lrclosed-fullfold/artefacts.src"; mkdir -p "$ART"
...
echo; echo "=========================================================="
echo "   cpx62-0219 — LR-CLOSED FULL-FOLD (54-pattern, fully symmetry-closed) — TRAJECTOIRE Elo"
