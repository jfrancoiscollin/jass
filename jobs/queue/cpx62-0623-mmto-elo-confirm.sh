#!/usr/bin/env bash
# id: cpx62-0623-mmto-elo-confirm
...
ART="/root/jass/jobs/results/cpx62-0623-mmto-elo-confirm/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0623-mmto-elo-confirm/artefacts"
