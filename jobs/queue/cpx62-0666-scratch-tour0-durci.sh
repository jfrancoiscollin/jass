#!/usr/bin/env bash
# id: cpx62-0666-scratch-tour0-durci
...
ART="/root/jass/jobs/results/cpx62-0666-scratch-tour0-durci/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0666-scratch-tour0-durci/artefacts"
