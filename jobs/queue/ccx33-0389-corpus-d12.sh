#!/usr/bin/env bash
# id: ccx33-0389-corpus-d12
# description: CORPUS continu ccx33 (chaîne alternée d12/d10, nourrit le fit au fur et à mesure). Génère 350000 pos
# @ d12 piloté par le champion (0378), committe UN shard gzippé. Le runner committe à la finalisation → shard
...
ART="/root/jass/jobs/results/ccx33-0389-corpus-d12/artefacts"; mkdir -p "$ART"
W=/root/cw-ccx33-0389-corpus-d12; rm -rf "$W"; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=12; EVAL_DEPTH=4; TARGET=350000; BATCH_MIN=25
SEED_CH=jobs/results/cpx62-0378-champion-geometry/artefacts/champion.pjtw.gz
preflight_build 1; preflight_note "corpus d12 350000" 90; preflight_check
...
gzip -c "$ACC" > "$ART/corpus-d12.jnnw.gz"
echo "=== shard d12 : $N pos, $(( $(stat -c%s "$ART/corpus-d12.jnnw.gz")/1000000 )) Mo gz → committé (maillon chaîne corpus) ==="
