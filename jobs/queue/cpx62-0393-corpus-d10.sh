#!/usr/bin/env bash
# id: cpx62-0393-corpus-d10
# description: CORPUS continu cpx62 (volume d10, vers les 30M du gros fit train_stream). Génère 1400000 pos
...
ART="/root/jass/jobs/results/cpx62-0393-corpus-d10/artefacts"; mkdir -p "$ART"
W=/root/cw-cpx62-0393-corpus-d10; rm -rf "$W"; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=10; EVAL_DEPTH=4; TARGET=1400000
SEED_CH=jobs/results/cpx62-0378-champion-geometry/artefacts/champion.pjtw.gz
preflight_build 1; preflight_note "corpus d10 1400000" 90; preflight_check
