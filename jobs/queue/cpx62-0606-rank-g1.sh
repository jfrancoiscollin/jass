...
ART="/root/jass/jobs/results/cpx62-0606-rank-g1/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0606-rank-g1/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-rankg1; rm -rf "$W"; mkdir -p "$W"; GEOM=/root/jass-geom32-rank
...
env JASS_PATTERNS_DIR="$GEOM" PYTHONPATH="$GEOM:pattern_jass/tools" python3 pattern_jass/tools/rank_finetune.py \
    ...
    --color-fold --tempo-stage --verify-jass "$J" --verify-n 80 >"$W/ft.log" 2>&1
FTRC=$?
