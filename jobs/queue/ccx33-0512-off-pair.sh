#!/usr/bin/env bash
# id: ccx33-0512-off-pair
# PAIRE MATCHEE (asym OFF, symetrique OFF/OFF = baseline) vs cpx62-0511-asym-pair (asym ON). Decideur : 0440(asym)-0440(OFF).
...
DB=/nonexistent/expert_games.db   # FORCE fallback seeds => matched avec le bras ASYM (0511)
export PREFLIGHT_CAP_MIN="${PREFLIGHT_CAP_MIN:-3000}"
source jobs/lib/preflight.sh
ART="/root/jass/jobs/results/ccx33-0512-off-pair/artefacts"; mkdir -p "$ART"
