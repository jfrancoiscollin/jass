#!/usr/bin/env bash
# id: ccx33-0491-forcing-ext-movetime-v3
...
ART="/root/jass/jobs/results/ccx33-0491-forcing-ext-movetime-v3/artefacts"; mkdir -p "$ART"
W=/root/cw-extmt3; mkdir -p "$W"
...
say "=== [v3 n=610] ext_forcing ON vs OFF @ movetime ${MOVETIME}s, openings=dilf (305), progress-file incremental ==="
