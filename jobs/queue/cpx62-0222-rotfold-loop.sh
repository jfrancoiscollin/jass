...
set -uo pipefail
cd /root/jass
ART="/root/jass/jobs/results/cpx62-0222-rotfold-loop/artefacts.src"; mkdir -p "$ART"
...
CFOLD="--rot-fold"     # bras ROT-FOLD (Phase 2 : couleur+rotation180)
declare -A ELO PRX
...
echo; echo "=========================================================="
echo "   cpx62-0219 — PHASE 2 ROT-FOLD — TRAJECTOIRE Elo"
