#!/usr/bin/env bash
# id: cpx62-0478-selfplay-pruningoff-ab
...
ART="/root/jass/jobs/results/cpx62-0478-selfplay-pruningoff-ab/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-pruneoff; rm -rf "$W"; mkdir -p "$W"
SCAN_BIN=/root/jass-scan/scan_linux
PILOT_GZ=jobs/results/ccx33-0454-egdb-mix/artefacts/champion-egdbmix.pjtw.gz
DILF=data/dilf_combinations.fen
GEOM32=/root/jass-geom32-pruneoff
NGEN=2500000; NEGDB=4000000; EVALDEPTH=4; PLAYDEPTH=8; OPEN=8
