#!/usr/bin/env bash
# id: 0118bis-pattern-jass-train-gate2
# description: Re-run 0118 avec fix install scipy (pip --break-system).
#
# 0118 a échoué Phase 2 : scipy non installé, pip install --quiet
# silenced les erreurs. Pattern correct (cf 0086) :
#   pip3 install --break-system-packages --no-cache-dir --quiet scipy
#
# Reste identique : train master 1.6M + bench Gate 2.
#
# expected_duration: ~1h wall
set -uo pipefail
cd /root/jass

OUT_BASE="/root/jass/jobs/results/0118bis-pattern-jass-train-gate2"
...
echo
echo "=========================================================="
echo "       0118bis PATTERN_JASS GATE 2 VERDICT"
echo "=========================================================="
