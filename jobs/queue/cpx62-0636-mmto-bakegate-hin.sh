#!/usr/bin/env bash
# id: cpx62-0636-mmto-bakegate-hin
...
ART="/root/jass/jobs/results/cpx62-0636-mmto-bakegate-hin/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0636-mmto-bakegate-hin/artefacts"
...
run_cell mt03_gen1 "$W/gen1.pjtw" 8 --movetime 0.3        & P3=$!
run_cell mt03_cand "$W/cand.pjtw" 8 --movetime 0.3        & P4=$!
wait $P1 $P2 $P3 $P4
