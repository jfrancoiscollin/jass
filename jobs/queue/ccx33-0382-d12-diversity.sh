#!/usr/bin/env bash
# id: ccx33-0382-d12-diversity
# description: GÉNÉRATEUR DE DIVERSITÉ d12 (parallèle à la boucle cpx62-0381). ccx33 génère un GROS lot de self-play
...
ART="/root/jass/jobs/results/ccx33-0382-d12-diversity/artefacts"; mkdir -p "$ART"
W=/root/cw-d12; rm -rf "$W"; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=12; EVAL_DEPTH=4; TARGET_TOTAL=900000; BATCH_MIN=25
...
SZ=$(gzip -c "$ACC" | wc -c)
gzip -c "$ACC" > "$ART/d12-diversity.jnnw.gz"
echo; echo "=========================================================="
