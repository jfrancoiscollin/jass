#!/usr/bin/env bash
# id: ccx33-0563-eval-oracle-scan
...
ART="/root/jass/jobs/results/ccx33-0563-eval-oracle-scan/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0563-eval-oracle-scan/artefacts"
