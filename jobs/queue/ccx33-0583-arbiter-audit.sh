...
ART="/root/jass/jobs/results/ccx33-0583-arbiter-audit/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0583-arbiter-audit/artefacts"
...
python3 - "$W/sub.jnnw" "$W/adeep.jnnw" "$DRAWBAND" 2>&1 | tee -a "$VERD" <<'PY'
import struct,sys,collections
REC=38
