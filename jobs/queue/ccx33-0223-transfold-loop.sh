...
set -uo pipefail
cd /root/jass
ART="/root/jass/jobs/results/ccx33-0223-transfold-loop/artefacts.src"; mkdir -p "$ART"
...
CFOLD="--trans-fold"     # bras TRANS-FOLD (Phase 3 : couleur+rot180+translation, ~Scan)
declare -A ELO PRX
...
echo; echo "=========================================================="
echo "   cpx62-0219 — PHASE 3 TRANS-FOLD — TRAJECTOIRE Elo"
