#!/usr/bin/env bash
# id: ccx33-0374-virtuous-loop-deep12
...
ART="/root/jass/jobs/results/ccx33-0374-virtuous-loop-deep12/artefacts.src"; mkdir -p "$ART"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=12; EVAL_DEPTH=4; SCALE=1000; NGEN=6; TARGET_GEN_MIN=20
