#!/usr/bin/env bash
# id: cpx62-0463-freshmix-egdbmix
# description: REPRISE du plan de base (0442) avec le PILOTE = champion-egdbmix (+58 Elo, le meilleur connu), apres
...
ART="/root/jass/jobs/results/cpx62-0463-freshmix-egdbmix/artefacts"; mkdir -p "$ART"
