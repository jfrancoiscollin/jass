#!/usr/bin/env bash
# id: ccx33-0493-selfplay-asym-clean-3m
...
ART="/root/jass/jobs/results/ccx33-0493-selfplay-asym-clean-3m/artefacts"; mkdir -p "$ART"
W=/root/cw-spasym-clean3m; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
GEOM32=/root/jass-geom32-spasym-clean3m
...
gzip -c "$W/champ.pjtw" > "$ART/champion-asym-clean3m.pjtw.gz"
