#!/usr/bin/env bash
# id: ccx33-0390-corpus-d10
# description: CORPUS continu ccx33 (chaîne alternée d12/d10, nourrit le fit au fur et à mesure). Génère 700000 pos
# @ d10 piloté par le champion (0378), committe UN shard gzippé. Le runner committe à la finalisation → shard
...
ART="/root/jass/jobs/results/ccx33-0390-corpus-d10/artefacts"; mkdir -p "$ART"
W=/root/cw-ccx33-0390-corpus-d10; rm -rf "$W"; mkdir -p "$W"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=10; EVAL_DEPTH=4; TARGET=700000; BATCH_MIN=25
SEED_CH=jobs/results/cpx62-0378-champion-geometry/artefacts/champion.pjtw.gz
preflight_build 1; preflight_note "corpus d10 700000" 90; preflight_check
