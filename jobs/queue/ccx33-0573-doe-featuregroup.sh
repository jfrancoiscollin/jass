#!/usr/bin/env bash
# id: ccx33-0573-doe-featuregroup
...
ART="/root/jass/jobs/results/ccx33-0573-doe-featuregroup/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0573-doe-featuregroup/artefacts"
