...
ART="/root/jass/jobs/results/ccx33-0657-doe-search-r2/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0657-doe-search-r2/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-doe-r2; rm -rf "$W"; mkdir -p "$W"
