#!/usr/bin/env bash
# id: ccx33-0634-mmto-bakegate-d9scan
...
ART="/root/jass/jobs/results/ccx33-0634-mmto-bakegate-d9scan/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0634-mmto-bakegate-d9scan/artefacts"
