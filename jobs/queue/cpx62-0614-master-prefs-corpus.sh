#!/usr/bin/env bash
# id: cpx62-0614-master-prefs-corpus
...
ART="/root/jass/jobs/results/cpx62-0614-master-prefs-corpus/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0614-master-prefs-corpus/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-mpref; rm -rf "$W"; mkdir -p "$W"
