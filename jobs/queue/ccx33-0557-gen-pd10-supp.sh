#!/usr/bin/env bash
# id: ccx33-0557-gen-pd10-supp
# description: SUPPLEMENT NUIT ccx33 (idle apres 0554) — 300k pd10 supplementaires, meme recette que 0556 (pilote gen1, archi complete, asym, quiet-only, combo-seed). Committe job-side, POOLABLE demain avec le mix2M de cpx62 (epaissit la tranche profonde si voulu, optionnel). AUCUN NNUE. ~4-5h (8 coeurs).
set -uo pipefail
cd /root/jass
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
ART="/root/jass/jobs/results/ccx33-0557-gen-pd10-supp/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-supp10; rm -rf "$W"; mkdir -p "$W"
...
ARTREL="jobs/results/ccx33-0557-gen-pd10-supp/artefacts"
...
# ---- SUPPLEMENT : 300k pd10 (poolable demain avec le mix2M de cpx62) ----
gen_phase 10 300000 "pd10supp"
say ""
say "  => supplement pd10 committe (phase-pd10supp.jnnw.gz) — POOLABLE demain avec corpus-mix2M (optionnel)."
say "=== fin supplement pd10 ccx33 ==="
