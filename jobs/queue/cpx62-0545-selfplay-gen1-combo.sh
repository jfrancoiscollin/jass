#!/usr/bin/env bash
# id: cpx62-0545-selfplay-gen1-combo
# description: PASSE SELF-PLAY combo-aware, generation 1 (JFC "commence le self-play pour la nuit"). But : maintenant que
...
ART="/root/jass/jobs/results/cpx62-0545-selfplay-gen1-combo/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-sp1; rm -rf "$W"; mkdir -p "$W"
GEOM32=/root/jass-geom32-sp1
# ---- params ----
...
gzip -c "$W/gen1.pjtw" > "$ART/champion-gen1-combo.pjtw.gz"
say "  nouveau champion gen1 -> $ART/champion-gen1-combo.pjtw.gz"
