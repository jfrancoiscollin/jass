...
ART="/root/jass/jobs/results/cpx62-0584-e1-clean/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0584-e1-clean/artefacts"
...
git checkout -- src/main.cpp pattern_jass/tools/train_stream.py pattern_jass/tools/gen_patterns.py 2>/dev/null || true
