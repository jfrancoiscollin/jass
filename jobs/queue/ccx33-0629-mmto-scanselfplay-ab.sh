#!/usr/bin/env bash
# id: ccx33-0629-mmto-scanselfplay-ab
...
ART="/root/jass/jobs/results/ccx33-0629-mmto-scanselfplay-ab/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/ccx33-0629-mmto-scanselfplay-ab/artefacts"
...
CAND_GZ=jobs/results/ccx33-0627-mmto-scan-selfplay-highvol/artefacts/spmmto_0.05.pjtw.gz
