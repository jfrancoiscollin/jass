...
ART="/root/jass/jobs/results/cpx62-0612-rank-g1/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0612-rank-g1/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-rankg1f; rm -rf "$W"; mkdir -p "$W"; GEOM=/root/jass-geom32-rank
