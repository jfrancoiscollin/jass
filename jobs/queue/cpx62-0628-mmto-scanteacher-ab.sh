#!/usr/bin/env bash
# id: cpx62-0628-mmto-scanteacher-ab
...
ART="/root/jass/jobs/results/cpx62-0628-mmto-scanteacher-ab/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0628-mmto-scanteacher-ab/artefacts"
...
CAND_GZ=jobs/results/ccx33-0625-mmto-scan-teacher/artefacts/scanmmto_0.05.pjtw.gz
