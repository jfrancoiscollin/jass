#!/usr/bin/env bash
# id: cpx62-0366-virtuous-loop-deep
...
ART="/root/jass/jobs/results/cpx62-0366-virtuous-loop-deep/artefacts.src"; mkdir -p "$ART"
NCPU=$(nproc); export TMPDIR=/root/jass/.compile-tmp; mkdir -p "$TMPDIR"
PLAY_DEPTH=10; EVAL_DEPTH=4; SCALE=1000; NGEN=6; TARGET_GEN_MIN=18
