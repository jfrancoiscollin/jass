...
ART="/root/jass/jobs/results/cpx62-0616-rank-g1-masterM/artefacts"; mkdir -p "$ART"
ARTREL="jobs/results/cpx62-0616-rank-g1-masterM/artefacts"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-g1masterM; rm -rf "$W"; mkdir -p "$W"; GEOM=/root/jass-geom32-rank
