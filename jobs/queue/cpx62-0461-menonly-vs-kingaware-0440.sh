#!/usr/bin/env bash
# id: cpx62-0461-menonly-vs-kingaware-0440
...
ART="/root/jass/jobs/results/cpx62-0461-menonly-vs-kingaware-0440/artefacts"; mkdir -p "$ART"
RES="$ART/RESULTS.txt"; : > "$RES"; say(){ echo "$@" | tee -a "$RES"; }
W=/root/cw-mk0440-62; rm -rf "$W"; mkdir -p "$W"
SCAN_BIN=/root/jass-scan/scan_linux
DILF=data/dilf_combinations.fen
GEOM32=/root/jass-geom32-mk62
...
HAVE_SCAN=0; [ -x "$SCAN_BIN" ] && HAVE_SCAN=1 || say "  (Scan absent sur cpx62 — conversion 0440 a faire sur ccx33 ; champions men/king committes)"
...
if [ "${HAVE_SCAN:-0}" = 1 ]; then
  ...
  say "  Scan absent sur cpx62 => champions men/king committes (artefacts) ; conversion 0440 vs Scan = job dedie ccx33 sur ces 2 champions."
fi
