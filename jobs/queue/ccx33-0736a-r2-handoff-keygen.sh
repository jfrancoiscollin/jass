#!/usr/bin/env bash
# id: ccx33-0736a-r2-handoff-keygen
# description: generate an ephemeral certificate for encrypted R2 configuration handoff
# expected_duration: <5 min
set -euo pipefail
cd /root/jass

JOB_ID="ccx33-0736a-r2-handoff-keygen"
EXPECTED_HOST="ubuntu-16gb-hel1-2"
OUT="jobs/results/$JOB_ID/artefacts.src"
KEY="/root/.jass-r2-handoff-0736-private.pem"
CERT="/root/.jass-r2-handoff-0736-cert.pem"
...
git add state/secure-handoff/ccx33-r2-0736-cert.pem state/secure-handoff/ccx33-r2-0736-meta.txt
