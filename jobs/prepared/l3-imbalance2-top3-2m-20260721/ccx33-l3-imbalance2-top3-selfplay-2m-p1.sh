#!/usr/bin/env bash
# id: ccx33-l3-imbalance2-top3-selfplay-2m-p1
# description: ccx33 P1 G1-G4 d8 from 16v18, 17v19 and 18v20 self-play only, 2M records per generation
# expected_duration: 30-60 h on ccx33
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set merged jass SHA in jass-control}"
export FULL_RUN_APPROVED=1 SCIENTIFIC_GO=1
export FRESH=2000000 PAR_GEN=6 MAXPLIES=260 LABEL_DEPTH=4 PLAY_DEPTH=8
...
exec bash jobs/templates/l3-imbalance2-top3-selfplay-2m-v1.sh
