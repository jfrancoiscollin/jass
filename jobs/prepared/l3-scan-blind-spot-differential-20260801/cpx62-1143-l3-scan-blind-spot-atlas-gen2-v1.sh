#!/usr/bin/env bash
# id: cpx62-1143-l3-scan-blind-spot-atlas-gen2-v1
# Second pass: same Scan protocol, historical Gen2 under the 32cf build.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set the SAME reviewed develop SHA as cpx62-1142}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="cpx62-1143-l3-scan-blind-spot-atlas-gen2-v1"
