#!/usr/bin/env bash
# id: home-0994-l3-pure-turnover-succession-preflight-v1
# Certify a fresh pool for the TURNOVER champion-succession gate. No games.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0994-l3-pure-turnover-succession-preflight-v1"
