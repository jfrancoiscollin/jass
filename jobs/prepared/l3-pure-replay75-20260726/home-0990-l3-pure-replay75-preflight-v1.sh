#!/usr/bin/env bash
# id: home-0990-l3-pure-replay75-preflight-v1
# Certify the REPLAY75 corpus (1.5M F2M epoch + 0.5M M2 epoch) and its pool.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0990-l3-pure-replay75-preflight-v1"
