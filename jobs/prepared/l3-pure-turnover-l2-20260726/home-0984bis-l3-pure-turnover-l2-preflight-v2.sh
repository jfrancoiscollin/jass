#!/usr/bin/env bash
# id: home-0984bis-l3-pure-turnover-l2-preflight-v2
# Schema-only retry: force-row completeness is W/D/L arithmetic, not a flag.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0984bis-l3-pure-turnover-l2-preflight-v2"
