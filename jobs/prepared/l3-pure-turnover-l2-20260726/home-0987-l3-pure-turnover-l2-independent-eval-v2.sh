#!/usr/bin/env bash
# id: home-0987-l3-pure-turnover-l2-independent-eval-v2
# Relaunch of home-0986 after the guard-engine witness fix; inputs unchanged.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0987-l3-pure-turnover-l2-independent-eval-v2"
