#!/usr/bin/env bash
# id: home-0971-l3-pure-d10-causal-fresh2m-train-v1
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0971-l3-pure-d10-causal-fresh2m-train-v1"
...
export PLATEAU_PREFIX="r2:jass-data/runs/home-0970bis-l3-pure-m2-independent-eval-v3/20260725T214024Z-f9ee6be0"
export EXPECTED_PLATEAU_JOB="home-0970bis-l3-pure-m2-independent-eval-v3"
export EXPERIMENT_VARIANT="D10_CAUSAL_FRESH2M"
export PLAY_DEPTH_OVERRIDE=10
export D10_CAUSAL_APPROVED=1
