#!/usr/bin/env bash
# Prepared only: not queued. Constant 2M fit volume, comparing 100% fresh
# against a deterministic 1M sample of the same 2M fresh corpus plus 1M
# authenticated rolling replay.
set -Eeuo pipefail
...
export COVERAGE_LEVER=replay_ratio
