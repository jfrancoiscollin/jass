#!/usr/bin/env bash
# Prepared only: uses the authenticated home-1017 UNIFORM corpus as common
# replay source and regret-archive source. Fill hashes after 1017 completes.
set -Eeuo pipefail
...
export COVERAGE_LEVER=regret_restart
