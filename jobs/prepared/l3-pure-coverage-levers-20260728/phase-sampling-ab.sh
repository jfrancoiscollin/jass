#!/usr/bin/env bash
# Prepared only: not queued. The launcher must pin the post-merge SHA, unique
# job id and the completed home-1017 result prefix.
set -Eeuo pipefail
...
export COVERAGE_LEVER=phase_sampling
