#!/usr/bin/env bash
# id: cpx62-0922bis-l3-conversion-2x2-g1-screen-v1
# description: clean retry of matched G1 2x2 standard/TOP3 starts x role-aware V2 off/on
# expected_duration: 30-45 min on measured cpx62 nproc=16; hard cap 60 min
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed develop SHA containing 0922bis}"
: "${EXPECTED_SCAN_SHA256:?set pinned Scan executable SHA256}"
: "${EXPECTED_SCAN_RUNTIME_SHA256:?set pinned Scan runtime fingerprint}"
export EXPECTED_JOB_ID="cpx62-0922bis-l3-conversion-2x2-g1-screen-v1"
