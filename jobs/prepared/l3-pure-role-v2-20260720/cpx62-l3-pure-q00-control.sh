#!/usr/bin/env bash
# id: cpx62-l3-pure-q00-control
# description: cpx62 independent paired control for L3-PURE Q00 without role-aware resampling
# expected_duration: pending per-box confirmation; explicit go required
set -Eeuo pipefail
