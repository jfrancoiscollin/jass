#!/usr/bin/env bash
# id: cpx62-l3-imbalance2-p2-v1
# description: L3-IMBALANCE2 P2; immutable parent required; exact TB teacher and 1/2/4 failure weighting
set -Eeuo pipefail
...
export FULL_RUN_APPROVED=1 SCIENTIFIC_GO=1 PHASE=P2
