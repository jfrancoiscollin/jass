#!/usr/bin/env bash
# id: cpx62-l3-imbalance2-p4-v1
# description: L3-IMBALANCE2 P4; immutable parent required; exact TB teacher and 1/2/4 failure weighting
set -Eeuo pipefail
...
export FULL_RUN_APPROVED=1 SCIENTIFIC_GO=1 PHASE=P4
...
exec bash jobs/templates/l3-imbalance2-runner-v1.sh
