#!/usr/bin/env bash
# id: home-0980-l3-pure-turnover-confirmation-v2
# Clean relaunch after 0979 failed before its first game on a Bash local/nounset bug.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0980-l3-pure-turnover-confirmation-v2"
