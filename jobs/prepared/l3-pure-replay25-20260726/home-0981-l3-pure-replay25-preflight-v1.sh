#!/usr/bin/env bash
# id: home-0981-l3-pure-replay25-preflight-v1
# Publish only after home-0980 completed and its exact R2 prefix is pinned.
set -Eeuo pipefail
: "${EXPECTED_CODE_SHA:?set reviewed merged SHA}"
export JASS_OBJSTORE_REMOTE="${JASS_OBJSTORE_REMOTE:-r2:jass-data}"
export EXPECTED_JOB_ID="home-0981-l3-pure-replay25-preflight-v1"
