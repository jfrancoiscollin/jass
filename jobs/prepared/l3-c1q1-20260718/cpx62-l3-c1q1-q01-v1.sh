#!/usr/bin/env bash
# id: cpx62-l3-c1q1-q01-v1
# description: L3-PURE C1-Q1 Q01_SACS, captures + sacrifices sélectifs depth0
# expected_duration: pending per-box micro-calibration; do not queue without explicit go
set -Eeuo pipefail
export ARM=A
export FRONTIER_FRAC=0
export L3_VARIANT=Q01_SACS
export L3_SEARCH_OVERRIDES="qs_threat_ext=0,qs_sacs=1,qs_sacs_depth0_only=1,qs_forcing_depth=0,qs_promo_depth=0"
