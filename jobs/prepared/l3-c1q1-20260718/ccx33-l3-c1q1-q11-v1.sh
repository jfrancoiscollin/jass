#!/usr/bin/env bash
# id: ccx33-l3-c1q1-q11-v1
# description: L3-PURE C1-Q1 Q11_THREAT_SACS, interaction menace + sacrifices sélectifs
# expected_duration: pending per-box micro-calibration; do not queue without explicit go
set -Eeuo pipefail
export ARM=A
export FRONTIER_FRAC=0
export L3_VARIANT=Q11_THREAT_SACS
export L3_SEARCH_OVERRIDES="qs_threat_ext=1,qs_sacs=1,qs_sacs_depth0_only=1,qs_forcing_depth=0,qs_promo_depth=0"
