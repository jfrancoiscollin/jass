#!/usr/bin/env bash
# id: cpx62-l3-imbalance2-p2-consolidate
# description: consolidate existing G4-G8 A64/B64 reports; no games replayed
# expected_duration: less than 10 minutes; fetch + symmetric clean + 10k bootstrap
set -Eeuo pipefail
