#!/usr/bin/env bash
# id: cpx62-l3-pure-m0-triangle
# description: L3-PURE M0 C0-A-G3 / P1-0842-G4 / gen2-mmto benchmark
...
export NOPEN=300 NSH_GATE=12 PAR_GATE=3 DEPTH=9 NATIVE_MOVETIME=0.3
export JASS_BUILD_JOBS=8

exec bash jobs/templates/l3-pure-m0-triangle-v1.sh
