#!/usr/bin/env bash
# id: home-0974bis-l3-pure-d12-causal-independent-eval-v1
set -Eeuo pipefail
export EXPECTED_CODE_SHA="4d10d40d7286a0f9c7c0f087403a9b5999806a48"
...
export EXPECTED_JOB_ID="home-0974bis-l3-pure-d12-causal-independent-eval-v1"
