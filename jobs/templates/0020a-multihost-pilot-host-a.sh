#!/usr/bin/env bash
# id: 0020a-multihost-pilot-host-a
# description: Multi-host pilot, host A's half. Validates that two
...
#                * have JASS_HOST_FILTER=0020a- in its systemd env
...
OUT_BASE="/root/jass/jobs/results/0020a-multihost-pilot-host-a"
...
echo "=== host facts ==="
echo "host:    $(hostname)"
echo "filter:  ${JASS_HOST_FILTER:-(unset, should be '0020a-')}"
echo "nproc:   $(nproc)"
...
# 0021 will combine host A's + host B's blobs into the final 200K dataset.
echo
...
echo
echo "=========================================================="
echo "       0020a MULTI-HOST PILOT (host A) SUMMARY"
echo "=========================================================="
echo "  host:           $(hostname)"
...
echo "Then queue 0021-merge-multihost-shards to combine host-a.bin"
