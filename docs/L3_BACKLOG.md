...
| H | attribution causale `CONTEXT_30` sur Jass 10×10 | CPX, non lancé | **préenregistré** : réutiliser `CURRENT_C30`, fitter SHUFFLED et OUTCOME strictement appariés, puis force hiérarchique sur deux pools neufs ; [protocole](experiments/L3_CONTEXT30_CAUSAL_GATE_PREREGISTRATION_20260816.md) |
