...
| TI-021 | ED2-P0 1875 / 20260908T171140Z-bc30d685; paired continuation 1876 on 27c30b3f | TECHNICAL observability gap: P0 initially exposed only a stale running record; subsequently resolved by completed READY/exit 0 terminal publication at 2026-09-08T18:10:26Z. Full source/build scratch publication exposure remains a separate confirmed code-level hazard. | Confirmed source-level exposure: original ED2 finalizers retain work/src and work/build while runner_v3_store copies/checks the whole run before terminal publication. Its contribution to P0 elapsed time is not established from host logs. P0 itself completed successfully, not a scientific failure. | Preserve all scientific data/models/seals, source identities, thresholds, logs and native binary identities. Remove only reproducible source/build scratch in future ED2 finalizers. Reauthenticate P0 READY/source/cost before paired training. Never infer live process status from a stale running marker or rewrite a prior terminal verdict. | jass-control/status/cpx62-1875-l3-ed2-data-teacher-preflight-v1.json blob 58be06659039bd97e94556c999fa74fdc549d9ba: completed exit 0, ED2_DATA_AND_TEACHER_PREFLIGHT_READY_V1, terminal 2026-09-08T18:10:26Z, source seal 31f763049fef50544bd1cbb240eeb4f51670728ae0697a77e982186df007152c. Jass #873 merged as 27c30b3f5b4bc4ee971bb4acfcf0a423e124f7da; cleanup preservation/path CI passed. Control #573 merged to queue 1876. Actual cleanup-enabled terminal proof is pending.; PR #874 | MITIGATED — P0 READY terminal authenticated; cleanup-enabled CPX runtime proof pending |
