...
| TI-014 | 1846, D1 WDL+listwise first runtime | stage exited 1 after about five minutes with inputs_authenticated=true, outputs_authenticated=false and no scientific verdict | D1 implementation guessed an exact 200000-row CURRENT_2M holdout, but the immutable game-level CURRENT split at seed 577215 / holdout-mod 10 has exactly 199204 holdout rows and 1800796 train rows | D1 must consume the exact archived CURRENT_2M split manifest; bootstrap repetitions (200000) must never be confused with holdout row cardinality | failed 1846 attempt 20260906T204702Z-2da8293b; historical jobs/templates/l3-context2-phase-tactical-fit-v1.sh freezes EXPECTED_HOLDOUT=199204 under the same split seed/mod; recovery regression test_d1_historical_split.py; PR #832 | MITIGATED — RERUN PENDING |
