# CLS panel — proposition d'amendement d'admission V1

Date : **21 septembre 2026**. Statut : **PROPOSED_NOT_APPROVED_NO_EXECUTION**.
...
Après approbation, cette version primera uniquement sur la règle d'identité
...
56 parties de readiness. Il ne résout pas le conflit découvert ci-dessous entre
deux contrats gelés. **Aucune de ces parties n'a été lancée.** L'approbation
requise porte sur cette nouvelle règle d'admission, pas sur un changement de
modèles, de parties ou d'analyse. Les matchs principaux gardent leur admission
explicite séparée.
...
Le code préparatoire de cette PR ne fournit que des fonctions de readiness et
des tests locaux. Il ne possède ni entrée de stage, ni profil de lancement, ni
job en file. L'amendement n'est pas effectif du seul fait de cette proposition.
