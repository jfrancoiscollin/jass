...
The passive SearchDecisionTrace workstream A proceeds independently: A1/A2 was merged in [PR #773](https://github.com/jfrancoiscollin/jass/pull/773), commit `107be69832111354cd61504aff208458979f26e9`, after the complete native suite (27,444 assertions), independent review and green native/Python/WASM CI. A3 exporter/readout was subsequently merged in [PR #776](https://github.com/jfrancoiscollin/jass/pull/776), commit `65311d7ddd2f830d229a9cb47da90bc070178437`, after 17 Python tests, nine CTest tests, real export/readout smokes, independent review and green native/Python/WASM CI. Its [contract](L3_SEARCH_DECISION_TRACE_A3_V1_20260905.md) limits the readout to local observed search horizons. B2 still requires a separately frozen confirmation; neither the B1 terminal nor the A3 instrumentation is a confirmation gate.
