...
Aucune O2 n'est autorisée automatiquement par ce terminal. Le programme de transfert E1/E2/E3 a été fusionné byte-identique via la PR `#735` (le draft `#733` a été fermé comme supersédé uniquement à cause d'un bug du connecteur Ready-for-review). Il répond à une question différente : **la valeur de l'information F6 une fois son coût et son effet d'expansion d'arbre séparés**.

Même après ce merge, chaque bloc E1/E2/E3 conserve son propre GO explicite et ses checks pré-lancement. Aucun strength game n'est implicitement autorisé.
