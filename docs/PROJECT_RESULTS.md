...
| menace × sacrifices sélectifs (écran C1-Q1) | `0806` factoriel 2×2 : effets menace −0,003, sacs −0,002, interaction +0,0002 ; conversion des 4 cellules ~0,67 ; gates common-search ~0,50 | aucun effet sur conversion ni force dans la lignée pure ; `q1_no_lead` | mécanisme de recherche co-adaptatif hors quiescence, ou signal sur une lignée plus mûre |
