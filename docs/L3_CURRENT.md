...
`SearchDecisionTrace` A1/A2 est intégré via la [PR #773](https://github.com/jfrancoiscollin/jass/pull/773), commit `107be69832111354cd61504aff208458979f26e9` : identité OFF/ON à profondeur/nœuds déterministes, 27 444 assertions natives, revue indépendante sans P1/P2, CI native/Python/WASM verte.
...
Les outils de [projection sans valeurs q200](experiments/L3_ADAPTIVE_SHADOW_B2_PROJECTION_V1_20260905.md) et de [preflight statistique synthétique](experiments/L3_ADAPTIVE_SHADOW_B2_STATISTICAL_PREFLIGHT_V1_20260905.md) sont intégrés via la [PR #780](https://github.com/jfrancoiscollin/jass/pull/780), commit `519ebe314688e37f91dba67398e87273cef9e14c`. Le preflight 1774 est terminé et authentifié : tentative `20260905T020003Z-519ebe31`, exit `0`, `B2_SYNTHETIC_STATISTICAL_PREFLIGHT_COMPLETE`, 200 000 réplications et 800 millions de tirages ; chaîne complète en 525,156 s, pic RSS de 349 532 160 octets, CPython 3.14.4 sur CPX62. Ce résultat est uniquement technique et synthétique. L'équivalence historique 1775 est également terminée et authentifiée : tentative `20260905T031428Z-fd2f1280`, code `fd2f1280804c27829fb6b946ae2fd52cdbe2937c` intégré par la [PR #781](https://github.com/jfrancoiscollin/jass/pull/781), exit `0`, `B1_HISTORICAL_PROJECTION_EQUIVALENCE_COMPLETE`. Sur 8 000 parents et 74 449 lignes, les décisions et résultats B1 concordent intégralement, avec rapport B1 identique et compteurs q200 de policy nuls. [Reçu et limites 1775](experiments/L3_ADAPTIVE_SHADOW_B2_LEGACY_EQUIVALENCE_RESULTS_20260905.md). À cette étape, les outils de sélection/teacher/fusion/readout et le préenregistrement final restaient nécessaires avant le gel B2 ; les avancées suivantes sont consignées ci-dessous. Aucun parent de confirmation n'a encore été généré et aucun seuil confirmatoire n'est gelé.

La sélection et le launcher des seize producteurs sont intégrés par la [PR #783](https://github.com/jfrancoiscollin/jass/pull/783), commit `c93717f4cbc7017233e850e3ccf0684d78680859`. La [PR #784](https://github.com/jfrancoiscollin/jass/pull/784), commit `ab60273de31a3c2d448d4e08553e6aeaf7dbc2cd`, ajoute la [fusion teacher et la vérification native des catalogues légaux](experiments/L3_ADAPTIVE_SHADOW_B2_TEACHER_MERGE_V1_20260905.md). Les neuf tests d'intégration Python passent avec le vrai vérificateur, dont la chaîne sur 4 000 parents synthétiques et seize shards ; revue indépendante sans P1/P2 et CI native/Python/WASM verte. Ces outils sont une préparation technique, sans cohorte confirmatoire exécutée.

Le smoke historique 1776 est terminé et authentifié : tentative `20260905T073548Z-c93717f4`, code `c93717f4cbc7017233e850e3ccf0684d78680859`, exit `0`, **`B2_TEACHER_NATIVE_SMOKE_COMPLETE`**. Un parent historique, douze siblings, 36 moteurs/recherches et 3 060 000 nœuds valident le build/lien et l'exécution du teacher avec CURRICULUM, EGDB et environnement vide. La chaîne du publisher prend 23,081 s, dont 1,068 s de teacher. Aucun score n'est lu pour une analyse scientifique et aucun parent B2 frais n'est généré. [Reçu, deux échecs techniques conservés et limites du smoke](experiments/L3_ADAPTIVE_SHADOW_B2_TEACHER_NATIVE_SMOKE_RESULTS_20260905.md). **La suite reste la validation de l'allocation/readout, puis le préenregistrement B2 avant toute génération de confirmation.**
